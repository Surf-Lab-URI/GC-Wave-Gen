function [BadFrameLFVSurf, XPIV_LFV,LFV_Surface_PIVMatched,LFV_Surface_Combo_Surface] = ExtractSurface_LFV_old(LFV_CR1,XPos,YPos,PIV1,XPIV_PIVSurf_Surface,PIVSurf_Surface,PIV_match_Surface,expName)
...
% Find transformation to match PIVSurf size
...
LFV_Surface_Combo_Surface = [a PS_Mod c];
LFV_Surface_Combo_Surface(length(a)-50:length(a)+50) = smooth(LFV_Surface_Combo_Surface(length(a)-50:length(a)+50),2);
LFV_Surface_Combo_Surface(end-length(c)+1-50:end-length(c)+50) = smooth(LFV_Surface_Combo_Surface(end-length(c)+1-50:end-length(c)+50),2);
% i=isnan(LFV_Surface_Combo_Surface);
% LFV_Surface_Combo_Surface=despike_fab(LFV_Surface_Combo_Surface);
% LFV_Surface_Combo_Surface(i)=NaN;
