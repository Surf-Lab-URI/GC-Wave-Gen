...
% Version 1.2
%
% This subroutine excludes spike noise from Acoustic Doppler Velocimetry 
% data using phase-space method, using modified Goring and Nikora (2002)
% method by Nobuhito Mori (2005). Further modified by Joseph Ulanowski to
% remove offset in output (2014).
% 
%=========================================================================%
%
% Input
...
%
%=========================================================================%
% Terms: Distributed under the terms of the terms of the BSD License.
% Copyright: Nobuhito Mori
...
if n_loop < n_iter
  % disp(['>> Number of outlier   = ', num2str(size(find(isnan(f)==1),1)), ...
