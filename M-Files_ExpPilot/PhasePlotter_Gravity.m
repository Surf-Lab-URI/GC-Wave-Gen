...
yLimits = [1850,2200]; %[1950,2150] for initial waves
...
%% Find Surface in all the frames
...
%%
P_threshold = 20; %5 used for initial waves
...
for i = 1:nF
    ...
    if mod(i,2) == 1
        ...
        plot(fXs(i,minsMask)*mpp,(fYs(i,minsMask)+offset)/dydt,'.r','MarkerSize',15)
    else
