...
DataPath=[ROOTPath 'ExpW' expName '\'];
   ...
   %% Parameters
    ...
    DT=200d-6; %delta_T =130 us between flashes
...
try
        ...
        %PIVSurf_PIVMatch is the PISsurf image cropped to matches the PIV image; PIVSurf_Surface is
...
%% Combo surface and phase        
  try
       ...
       [BadFrameLFVSurf,XPIV_LFV_Surface_PIVMatched,LFV_Surface_PIVMatched,LFV_Surface_Combo_Surface] = ExtractSurface_LFV(NORM_LFV,LFV_CR1,XPIV_PIVSurf_Surface,PIVSurf_Surface,PIVFused_Surface);
        ...
        %LFV_Surface_Combo_Surface is the surface detected on the LFV image
        %image but with the PIVSurf_Surface inserted
        %PIVSurf_PIVMatch is the PISsurf image cropped to matches the PIV image; PIVSurf_Surface is
