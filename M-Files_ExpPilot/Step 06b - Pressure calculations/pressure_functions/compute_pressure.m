...
function [Lapl, press] = compute_pressure(CST,PIVRes,transfo,cartDiff,GrdSpc)
...
% Convert to "pix", "pair"
rhoA_piv = CST.AIR_DENSITY*CST.DX^3; % Convert density to kg/(pix^3)
mu_piv = CST.DVISCOSITY*CST.DX*CST.DT; % Convert dynamic viscosity to kg/(pix^3)
Tol = CST.TOLERANCE/CST.DX;
...
% Smooth acceleration
lambda_cut = 0.01/CST.DX;   % cutoff wavelength in [m] (same units as xLong)
