...
for i = 2%:length(ExpDir) % Loop on the number of experiments
    ...
    for ii = [8:15] %1:numel(RunDir) % Loop on the number of Runs
        ...
        for idx = 1501:2250%numel(image_index) % Main Loop
