...
LONG=['H:\FabMarcNovDec2014\Data\Longitudinal\PIVdt10ms_IRlas1_8hz']
...
for image_pair_number=317:number_of_pair-1
%PIV
...
for ii=6:length(DIRS)

exp_name=DIRS(ii).name;

num_of_digits = 3;
load_path = ['H:\FabMarcNovDec2014\Data\Longitudinal\PIVdt10ms_IRlas1_8hz\' exp_name];
files=dir([load_path '\PIVRaw\PIV\*.mat']);
number_of_pair=length(files)/2;
