function transfo = generateTransfo_LC_noLFV(compVel, Surface_PIV, pivRes)
%
...
X=724+pivRes.GS-1:pivRes.GS:724+2047-pivRes.GS;
...
for z_index = 1:length(h)
    ...
    % loop on wavenumbers
    for i = 1:(N/2+1)/compVel.GS % limit to modes all the way to PIV resolution GS, no need to go beyong 
