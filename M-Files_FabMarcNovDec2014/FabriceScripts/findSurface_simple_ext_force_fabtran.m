...
% 08/22/2013
%%
function imSurf = findSurface_simple_ext_force_fabtran(IM_a, d1)
...
badFrameBool=0;
surfTechnique=1;
surface=surface(662-30:662-30+2047)-1588+467;  %1585, 453

%Surface_PIV1=imSurf1.surface(662-30:662-30+2047); %in this resized surface image, x=724 is the left edge of PIV image
%Surface_PIV1=Surface_PIV1-1588+467; 
...
surface2=surface2(662-30:662-30+2047)'-1588+467; 
surfTechnique2=2;
