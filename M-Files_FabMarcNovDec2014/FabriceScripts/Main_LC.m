...
imSurf1=Surface_PIV1-1838+370; %still water is Y=1838 in PIVsurf and Y=370 in PIV
...
imSurf2=Surface_PIV2-1838+370;

[h, w] = size(IM_a); %image height and width
mask1=ones(size(IM_a));
mask2=ones(size(IM_a));
for i=1:w
    mask1(1:round(imSurf1(i)),i)=NaN;
    mask2(1:round(imSurf2(i)),i)=NaN;
end
warning off
imSurf1.surface=imSurf1;
imSurf1.mask=mask1;
imSurf2.surface=imSurf2;
imSurf2.mask=mask2;
