...
imSurf1 = findSurface_simple_ext_force_fabtran(IM_a,d1);
Surface_PIV1=imSurf1.surface;


d2=imresize(imgPivsurf2,147.36/90.77);
imSurf2 = findSurface_simple_ext_force_fabtran(IM_b,d2);
Surface_PIV2=imSurf2.surface;
...
compVel =  computeVelocities_marc_quick_nofilt_LIF(IM_a, IM_b, mask1, mask2, IntrWndw, GrdSpc);
compVel.DX=1/14736; %m per pix
compVel.DT=8d-3; % sec per image pair -  DELTA_T= 8 milisec
