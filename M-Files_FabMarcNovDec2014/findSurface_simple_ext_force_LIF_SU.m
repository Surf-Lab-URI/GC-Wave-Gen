...
% 08/22/2013
%%
function imSurf = findSurface_simple_ext_force_LIF_SU(IM_a, d1)
...
badFrameBool=0;
surfTechnique=1;
surf=surface(714:714+2047)-1835+364;
%
...
surf2=surface2(714:714+2047)'-1835+364;
surfTechnique2=2;

if (abs(mean(surfacePIV-surf))<abs(mean(surf-surf2)))
