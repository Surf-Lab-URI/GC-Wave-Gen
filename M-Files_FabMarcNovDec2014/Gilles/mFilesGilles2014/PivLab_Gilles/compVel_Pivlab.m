 ...
 function [xtable, ytable, utable, vtable, typevector] = compVel_Pivlab (image1,image2,interrogationarea, step, subpixfinder, mask_inpt, roi_inpt,passes,int2,int3,int4,imdeform)

% 
% image1 = IM1;
% image2 = IM2;
% interrogationarea = 64; 
% step = interrogationarea/2; % Pour un overlap de 50%
% subpixfinder = 2; %  ==1 SUBPIXGAUSS ou ==2 SUBPIX2DGAUSS
% mask_inpt = mask1;
% roi_inpt = [1 1 2047 2047]; 
% passes = 4;
% int2 = 32;
% int3 = 16;
% int4 = 8;
...
%     end
%     mask(mask>1)=1;
    mask = mask_inpt;  %%%%%%%%%%%%%% ou  mask = mask_inpt(1:step:...)
