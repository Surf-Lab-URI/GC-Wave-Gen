...
save_path = ['E:\ComputedVelocities\20140730\LC3dt15\'];
...
% image_pair_number = 350
    ...
    image_letter='a';
     ...
     n = 2048;
     m = 2048;
     rawFrame = ['E:\data\20140730\LC3dt15\Movie3_Scene3_pivcc_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number*2) '.raw'];
     matFrame = saveToMatSingleFrame(rawFrame,n,m);
     IM1 = matFrame.img;

     %%Chargement et correction de Pivsurf
     rawFrame = ['E:\data\20140730\LC3dt15\Movie3_Scene3_pivsurfcc_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number*2) '.raw'];
     matFrame = saveToMatSingleFrame(rawFrame,n,m);
    ...
    rawFrame = ['E:\data\20140730\LC3dt15\Movie3_Scene3_pivcc_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number*2+1) '.raw'];
    matFrame = saveToMatSingleFrame(rawFrame,n,m);
    IM2 = matFrame.img;
    
    rawFrame = ['E:\data\20140730\LC3dt15\Movie3_Scene3_pivsurfcc_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number*2+1) '.raw'];
    matFrame = saveToMatSingleFrame(rawFrame,n,m);
