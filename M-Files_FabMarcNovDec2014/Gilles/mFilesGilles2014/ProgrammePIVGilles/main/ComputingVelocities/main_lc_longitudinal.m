...
% image_pair_number = 612
    ...
    Orbitals = calcOrbitals_hybrid(surfLfv,surfbig,vResLfv,hResLfv,pivRes,deltaT,pivResReal,IntrWndw,GrdSpc,lim_left_big,lim_left,lim_right);
        ...
        imgLfv_t=imtransform(imgLfv_LD,tformLfv,'XYScale',1);
        imgLfv_t_cut = imgLfv_t(75:13692, 536:14161);
        surfLfv = findSurface_lc(imgLfv_t_cut);
        Orbitals2 = calcOrbitals_hybrid2(surfLfv,surfbig,vResLfv,hResLfv,pivRes,deltaT,pivResReal,IntrWndw,GrdSpc,lim_left_big,lim_left,lim_right);
