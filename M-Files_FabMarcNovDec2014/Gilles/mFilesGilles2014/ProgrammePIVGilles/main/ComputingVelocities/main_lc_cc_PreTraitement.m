...
save_path = ['E:\ComputedVelocities\20140826\LC1_4\'];
start_image_pair_number = 368;
end_image_pair_number = 368;
% %  Remarque : dt=12.5ms
...
for image_pair_number = start_image_pair_number:end_image_pair_number
    ...
    SurfMASK.z_s_f = nansum(compVel1.mask);  % On recupere la surface
    SurfMASK.z_s_f = size(compVel1.mask,1) - SurfMASK.z_s_f; % On la remet dans "le bon sens"
