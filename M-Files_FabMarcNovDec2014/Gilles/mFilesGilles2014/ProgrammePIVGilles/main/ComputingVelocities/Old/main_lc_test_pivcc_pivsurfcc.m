...
start_image_pair_number = 388;
end_image_pair_number = 388;


u = [223 1811 1011]'; v = [892 908 1809]'; x = [1499 582 1037]'; y = [1001 1003 506]'; 
...
% image_pair_number = 350
    ...
    image_letter='a';
     ...
     rawFrame = ['E:\Movie4_Scene2\Movie4_Scene2_pivsurfcc_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number*2) '.raw'];
     matFrame = saveToMatSingleFrame(rawFrame,n,m);
    ...
    rawFrame = ['E:\Movie4_Scene2\Movie4_Scene2_pivsurfcc_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number*2+1) '.raw'];
    matFrame = saveToMatSingleFrame(rawFrame,n,m);
