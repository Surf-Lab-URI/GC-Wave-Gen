...
%     Lfv_LD = correctLfvLensDist_lc(Lfv);
    ...
    %% Calcul de la PIV
    SU1 = SUcc(surfLfv, surf1, ResPiv, hResLfv, vResLfv, 1);
    SU2 = SUcc(surfLfv, surf2, ResPiv, hResLfv, vResLfv, 1);
    dSU = SU2-SU1;  %% Je serais tente de rajouter un gros smoothn bien costaud N.B. Le faire sur les surf1 et surf2, moins couteux
    %     Interpoler dSU sur surf1 et s'en servir comme initialisation pour
    %     compVel
    IMM1 = interpTransfoInverse2(IM1,SU1);
    IMM2 = interpTransfoInverse2(IM2,SU2);
    ...
    compVel = PIV_FAB6_LfvOrb1_noOrb (IMM1,IMM2, mask1, mask2, IntrWndw, GrdSpc);
    compVel1 = computeVelocities_Fab(IMM1, IMM2, mask1, mask2, IntrWndw, GrdSpc);
    ...
    SUMASK = SUcc(surfLfv, SurfMASK, ResPiv, hResLfv, vResLfv, 1);
    ...
    save(outfile, 'compVel','compVel1','dSUInterp');
