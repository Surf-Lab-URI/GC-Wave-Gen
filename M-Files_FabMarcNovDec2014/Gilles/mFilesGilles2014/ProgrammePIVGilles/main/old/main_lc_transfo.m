...
%     On applique l'interpolation 'inverse' sur compVel en utilisant
    ...
    pivResMod=GrdSpc(end)*pivRes;
%     xxx=[1:1:2048];
%     www=[1:1:3785];
%     xxxx=[1:2048/255:2048];
%     wwww=[1:3785/472:3785];
%     Transfo22=interp2(xxx,www,Transfo2,xxxx,wwww); % Trouve pq ca ne marche pas
   ...
   % difference Transfo2-Transfo1 ... foireux et surement pas tres
   % rigoureux
   ...
   imgTransfoInverse.dely_int2=imgTransfoInverse.dely_int+Transfo33;
    ...
    figure,imagesc(imgTransfoInverse.delx_int), colorbar, caxis([-25 25])
    figure,imagesc(imgTransfoInverse.dely_int), colorbar, caxis([-25 25])
    figure,imagesc(imgTransfoInverse.dely_int2), colorbar, caxis([-25 25])
...
% %%
% figure,imagesc(compVel.delx_int.*compVel.MASK), colorbar
% figure,imagesc(compVel.dely_int.*compVel.MASK), colorbar
