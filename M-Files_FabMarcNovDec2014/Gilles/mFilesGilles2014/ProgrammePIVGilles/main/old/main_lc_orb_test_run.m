...
%     Ajouter la possibilite de lire le moyen en fonction de la profondeur
...
%     end
    ...
    imgTransfo255472 = interpTransfo255472(surf1,compVel.delx_ints,Orbitals.SU,GrdSpc);
    for i=1:size(imgTransfo255472,1)
        Courant(i)=mean(imgTransfo255472(i));
    end
