function Orbitals = calcOrbitals_lc_lfv(surfLfv,imgLfv_t_cut,vRes,hRes,pivRes,iws,deltaT,pivResReal,IntrWndw,GrdSpc,lim_left,lim_right)
...
% s2 = sin(pi*xx/5000);
dx = pivRes;
x_s = lim_left+GS:GS:lim_left+lim_right-IW/2;
z_s = 0:GS:2048;
