...
start_image_pair_number = 341;
end_image_pair_number = 360;
...
imgPivsurfcc_rect_cut=imgPivsurfcc_rect(1265-783-15-70-50-5:end-15-70-50-5,369+8:1953+369+8);

% close all
% figure, imagesc(imgPivcc_rect_cut), colormap(bone), caxis([0 500])
% gg = ginput(2);
% gg(2,2) - gg(1,2)
% gg(2,1) - gg(1,1)
% 
% figure, imagesc(imgPivsurfcc_rect_cut), colormap(bone), caxis([0 2000])

% figure, imagesc([imgPivsurfcc_rect_cut(1:810, :); imgPivcc_rect_cut(811:end, :)]), colormap(bone), caxis([0 2000])
