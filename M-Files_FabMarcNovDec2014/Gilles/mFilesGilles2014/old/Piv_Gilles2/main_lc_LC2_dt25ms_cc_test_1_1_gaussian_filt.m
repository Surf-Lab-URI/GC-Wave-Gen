...
% start_image_pair_number = 301;
% end_image_pair_number = 320;
...
image_pair_number = 391
    ...
    IM1 = imgPivcc_rect_cut - imfilter(imgPivcc_rect_cut,h);
...
%     clear pivsurf_struc imgPivsurf imgPivsurf_t_cut
    ...
    IM2 = imgPivcc_rect_cut - imfilter(imgPivcc_rect_cut,h);
%     IM2 = imgPivcc_rect_cut - medfilt2(imgPivcc_rect_cut,[5 5]);
%     (p2_25-medfilt2(p2_25,[5 5]))
...
%     compVel = computeVelocities(exp_name, image_pair_number, IM1, IM2, mask2);
    ...
    filename = ['Exp' exp_name '_compVel_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number) 'test_medfilt'];
