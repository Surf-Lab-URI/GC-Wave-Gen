...
IntrWndw = [32]; % IntrWndw=[128 64 32 16 8];
GrdSpc = [16]; 
...
%     compVel = PIV_FAB6_LfvOrb1_noOrb_one_lvl (IM1,IM2, mask1, mask2, IntrWndw, GrdSpc);
%     
%     filename = ['Exp' exp_name '_compVel_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number) 'test_piv_routine32_16'];
