...
%     clear pivsurf_struc imgPivsurf imgPivsurf_t_cut
    ...
    %% piv calc
    compVel = PIV_FAB6_LfvOrb1_noOrb_ct (IM1,IM2, mask1, mask2, IntrWndw, GrdSpc,0.5, 0.8);
    
    filename = ['Exp' exp_name '_compVel_' sprintf(['%0' num2str(num_of_digits) 'd'], image_pair_number) '_test'];
