function [delx_int dely_int, delx_ints, dely_ints, MASK, dwhatlevel, dcor] = PIV_FAB6_incrementing_correlation_and_phase_LfvOrb1 (IM1,IM2, mask1, mask2, delxOrb, delyOrb)
...
IntrWndw = [32 16 8]; % IntrWndw=[128 64 32 16 8];
GrdSpc = [16 8 4]; % GrdSpc=[64 32 16 8 4];
