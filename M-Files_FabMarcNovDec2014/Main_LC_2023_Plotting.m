...
while image_pair_number < number_of_pair-1
    ...
    figure(1)
    imagesc(imgPivsurf1, [0,300])
    figure(2)
    imagesc(imgPivsurf2, [0,300])
...
SurfMask = 1;
imSurf1 = CrapperOptimized_FindSurface(s1, surfSigmas, surfSteps, 1);
imSurf2 = CrapperOptimized_FindSurface(s2, surfSigmas, surfSteps, 1);
